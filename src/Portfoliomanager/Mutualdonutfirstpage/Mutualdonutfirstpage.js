...
const  Mutualportfoliodonutfirst = () => {
  const data = {
    todayGain: {
      totalGaining: 0,
      totalLosing: 1,
  ...
  <div>
    ...
    <div className="networth-stocks-dashboard">
      ...
      <div className="networth-tabs">
        ...
        <button className="networth-tabact">Mutual Fund</button>
...
/>
  ...
  0 of 1 in profit{" "} 
              ...
              <p style={{ fontSize: "15px",color: "black" ,borderTop:"1px solid grey ",marginLeft:"15px"}}><br/>
              1 of 1 in Loss{" "} 
              </p>
...
export default Mutualportfoliodonutfirst;
